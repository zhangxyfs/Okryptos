...
<p align="center">
  <img alt="version" src="https://img.shields.io/badge/version-2.26.3-2563eb">
...
<p align="center">
  <b>Okryptos · 归藏</b>（音译「奥克吕普托斯」）——源自古希腊词根，意为「受启而显的秘藏」。<br>
  归藏者，纳万理于幽，应机而启。
</p>

<p align="center">
  面向 <b>AI-Agent Hooks</b> 的隐性知识库——沉淀参考资料、笔记、规则与踩坑经验，<br>
  知识静默封存，经由 Agent Hook 触发方才对外输出；支持多设备迁移、团队知识共享。<br>
  单二进制 Go CLI（<code>ok</code>），零运行时依赖。
</p>
