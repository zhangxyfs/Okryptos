...
void DockScene::drawCard(D3DContext& d3d, IMaterial& material,
  ...
  // 卡文本恒浅色：四材质卡底均为深色玻璃（frost 88%/glow 86%），亮背景也成立
