...
set "CORE=core\*.cpp"
set "ADAPT=adapters\kimi\*.cpp adapters\claude\*.cpp adapters\codex\*.cpp adapters\qwen\*.cpp adapters\zcode\*.cpp adapters\workbuddy\*.cpp adapters\reasonix\*.cpp adapters\hanako\*.cpp"
