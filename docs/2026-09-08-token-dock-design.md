...
- **悬停反馈（原型 .hot/.dim 语义）**：悬停项按形态放大（弧线 1.34 / 胶囊 1.08 / 罗盘 1.22 / 电平柱·波形流 1.07 / 辉光 1.14），**其余项降不透明度**（球体 .6 且 scale(.9) 回缩，块状形态 .55 不回缩）；块状项悬停**不画 accent 描边**（用户裁决），球体弧线相邻项沿弧线让位。动画 150~200ms 缓动。
